...
def extract_audio_features(y, sr, hop_length, frame_size_ms=20, clip_size_s=1000,
                            music_lster_threshold = 0.25, music_zstd_threshold = 0.3, 
    ...
    for i in range(num_clips):
        ...
        clip_features['lster'].append(compute_lster(ste_in_clip))  
...
def detect_music(lster, zstd, lster_threshold = 0.25, zstd_threshold = 0.3):
