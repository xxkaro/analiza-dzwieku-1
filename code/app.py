...
if uploaded_file is not None:
    ...
    with col1:
        ...
        if detection == "Muzyka / Mowa":    
            music_lster_threshold = st.slider("Wybierz próg dla LSTER:", min_value=0.0, max_value=1.0, step=0.005, value=0.25, format="%0.3f")
            music_zstd_threshold = st.slider("Wybierz próg dla ZSTD:", min_value=0.0, max_value=0.5, step=0.005, value=0.3, format="%0.3f")
